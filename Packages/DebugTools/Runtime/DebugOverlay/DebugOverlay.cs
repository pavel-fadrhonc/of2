...
public class DebugOverlay : MonoBehaviour
{
    ...
    public static void Render(Camera cam, CommandBuffer cmd)
    {
        if (!instance)
            return;
        instance._Render(cam, cmd);
    }

    public static void Render3D(Camera cam, CommandBuffer cmd)
    {
        if (!instance)
            return;
        instance._Render3D(cam, cmd);
    }
    
    void _Render(Camera cam, CommandBuffer cmd)
    {
    ...
    void _Render3D(Camera hdCamera, CommandBuffer cmd)
    {
