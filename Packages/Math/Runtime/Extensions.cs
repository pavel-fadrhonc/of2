...
namespace Freya {
	...
	public static class MathfsExtensions {
		...
		public static Vector2 ClampNeg1to1( this Vector2 v ) => new Vector2( Mathfs.ClampNeg1to1( v.x ), Mathfs.ClampNeg1to1( v.y ) );
		public static Vector3 ClampNeg1to1( this Vector3 v ) => new Vector3( Mathfs.ClampNeg1to1( v.x ), Mathfs.ClampNeg1to1( v.y ), Mathfs.ClampNeg1to1( v.z ) );
