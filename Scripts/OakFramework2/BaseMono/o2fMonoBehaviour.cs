...
namespace OakFramework2.BaseMono
{
    ...
    /// NNGameObject inherits from this and most objects should inherit from NNGameObject. 
    ...
    /// </summary>
    public class o2fMonoBehaviour : MonoBehaviour
    {
        ...
        public static void CleanUpNNMonoBehaviours(GameObject go)
        {
            ...
            o2fMonoBehaviour[] embs = go.GetComponentsInChildren<o2fMonoBehaviour>(true);
